...
function calc() {
    ...
    function initLocalSettings(selecrtor, activeClass) {
        const elements = document.querySelectorAll(selecrtor);
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', '2022-08-12');
